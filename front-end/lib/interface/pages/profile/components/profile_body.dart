...
class ProfileBodyState extends State<ProfileBody> {
          ...
          children: [
            ...
            Center(
                child: Container(
                    ...
                    child: (service.getPicture("/users/me/photo") == null)
                        ? Container(
                            decoration: BoxDecoration(
                                shape: BoxShape.circle, color: primaryColor))
                        : service.getPicture("/users/me/photo"))),
            Padding(
              ...
              child: BarChart(
                [
                  new Series<StepsPerDay, String>(
                    ...
                    domainFn: (StepsPerDay stepsPerDay, _) =>
                        stepsPerDay.dateString(),
                    measureFn: (StepsPerDay stepsPerDay, _) =>
                ...
                domainAxis: OrdinalAxisSpec(
                    renderSpec: SmallTickRendererSpec(
                        labelStyle: TextStyleSpec(
                            fontSize: 18, color: MaterialPalette.white),
                        lineStyle:
                            new LineStyleSpec(color: MaterialPalette.white))),
  ...
  Container buildWeeklyAchievements() {
    ...
    return Container(
        height: baseHeight * 2 +
            (screenSize.height * 0.072) * dummyAchievements.length,
        width: screenSize.width * 0.95,
        child: Column(
          children: [
            Padding(padding: EdgeInsets.only(top: 10)),
                    ...
                    return Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          Icon(Icons.star,
                              size: smallIconSize, color: Colors.white),
